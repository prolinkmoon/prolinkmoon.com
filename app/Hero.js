...
<section
  ...
  <div className="relative z-10 max-w-7xl mx-auto pt-40 pb-20">
    ...
    <p className="mt-4 text-sm sm:text-base text-gray-300 leading-relaxed max-w-xl">
      I run blockchain nodes, build tools for the community, and share early alpha airdrop opportunities — all to support builders, learners, and explorers in the web3 space. Let’s shape a more open, decentralized future together.
    </p>
    ...
    <div className="mt-5">
      <a
        ...
        onClick={(e) => {
          e.preventDefault();
          document.querySelector("#prolinkmoon").scrollIntoView({ behavior: "smooth" });
        }}
      >
